...
@section('content')
    <section class="content">
        <form action="/master-data/kecamatan/edit/{{ $kecamatan->id }}" method="POST">
            @method('POST')
            @csrf
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="3">{{ $kecamatan->description }}</textarea>
