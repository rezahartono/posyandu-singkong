                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <x-text-input label="RT / RW" type="text" id="rt_rw" name="rt_rw"
                                placeholder="Lokasi RT / RW" value="{{ old('rt_rw') }}" />
                            <x-dropdown-input label="Puskesmas" id="puskesmas" name="puskesmas"
                                placeholder="Pilih Puskesmas..." :items="$form_data['puskesmas']" />
                            <x-dropdown-input label="Kelurahan" id="kelurahan" name="kelurahan"
                                placeholder="Pilih Kelurahan..." :items="$form_data['kelurahan']" />
                            <x-dropdown-input label="Kecamatan" id="kecamatan" name="kecamatan"
                                placeholder="Pilih Kecamatan..." :items="$form_data['kecamatan']" />
                            <x-dropdown-input label="Kabupaten/Kota" id="kota" name="kota"
                                placeholder="Pilih Kabupaten/Kota..." :items="$form_data['kota']" />
                            <x-dropdown-input label="Bulan Kegiatan" id="bulan" name="bulan"
                                placeholder="Pilih Bulan..." :items="$form_data['bulan_kegiatan']" />
                            <x-dropdown-input label="Tahun" id="tahun" name="tahun" placeholder="Pilih Tahun..."
                                :items="$form_data['tahun_kegiatan']" />
                            <x-text-input label="Tanggal Dibuat" type="datetime-local" id="tanggal_dibuat"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-4">
                                    <div class="form-group row">
                                        <span class="col-2 col-form-label h5">RT</span>
                                        <div class="col-10">
                                ...
                                <div class="col-4">
                                    <div class="form-group row">
                                        <span class="col-2 col-form-label h5">RW</span>
                                        <div class="col-10">
                            ...
                            <x-text-input label="KB" type="text" id="kb" name="kb" placeholder="KB"
                                value="{{ old('kb') }}" />
                            <x-text-input label="Lingkar Kepala" type="number" id="lingkar_kepala"
                                name="lingkar_kepala" placeholder="Lingkar Kepala" value="{{ old('lingkar_kepala') }}"
                                append-label="CM" />
                            <x-text-input label="Lingkar Lengan" type="number" id="lingkar_lengan"
                                name="lingkar_lengan" placeholder="Lingkar Lengan" value="{{ old('lingkar_lengan') }}"
                                append-label="CM" />
                            <div class="row">
                                <div class="col-4">
