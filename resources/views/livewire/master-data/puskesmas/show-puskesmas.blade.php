<div>
    <div class="row bg-white p-3 rounded rounded-5 shadow shadow-sm" style="max-height: 100%">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <div class="ms-auto">
                <a href="puskesmas/create" class="btn btn-primary"><i class="fas fa-plus mr-2"></i>Buat Puskesmas</a>
            </div>
        </div>
                ...
                <table class="table table-bordered rounded rounded-5">
                    <thead class="bg-primary text-white">
                        <tr>
                            ...
                            <th class="text-center" scope="col">Nama Puskesmas</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($puskesmas as $puskes)
                            <tr>
                                ...
                                <td class="text-center">{{ $puskes->name }}</td>
                                <td class="text-center">{{ $puskes->description }}</td>
                                <td class="text-center">
                                    <a href="/master-data/puskesmas/edit/{{ $puskes->id }}" class="btn btn-primary">
                                        <i class="fas fa-edit"></i>
                                    </a>

                                    <a href="/master-data/puskesmas/delete/{{ $puskes->id }}" class="btn btn-danger">
