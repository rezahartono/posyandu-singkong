<div>
    <div class="row bg-white p-3 rounded rounded-5 shadow shadow-sm" style="max-height: 100%">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <div class="ms-auto">
                <a href="kecamatan/create" class="btn btn-primary"><i class="fas fa-plus mr-2"></i>Buat Kecamatan</a>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($kecamatan as $kec)
                            <tr>
                                ...
                                <td class="text-center">{{ $kec->name }}</td>
                                <td class="text-center">{{ $kec->description }}</td>
                                <td class="text-center">
                                    <a href="/master-data/kecamatan/edit/{{ $kec->id }}" class="btn btn-primary">
                                        <i class="fas fa-edit"></i>
                                    </a>

                                    <a href="/master-data/kecamatan/delete/{{ $kec->id }}" class="btn btn-danger">
