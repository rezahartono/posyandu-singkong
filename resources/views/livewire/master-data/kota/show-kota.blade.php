<div>
    <div class="row bg-white p-3 rounded rounded-5 shadow shadow-sm" style="max-height: 100%">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <div class="ms-auto">
                <a href="kota/create" class="btn btn-primary"><i class="fas fa-plus mr-2"></i>Buat Kabupaten/Kota</a>
            </div>
        </div>
                ...
                <table class="table table-bordered rounded rounded-5">
                    <thead class="bg-primary text-white">
                        <tr>
                            ...
                            <th class="text-center" scope="col">Nama Kabupaten/Kota</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($kota as $kab)
                            <tr>
                                ...
                                <td class="text-center">{{ $kab->name }}</td>
                                <td class="text-center">{{ $kab->description }}</td>
                                <td class="text-center">
                                    <a href="/master-data/kota/edit/{{ $kab->id }}" class="btn btn-primary">
                                        <i class="fas fa-edit"></i>
                                    </a>

                                    <a href="/master-data/kota/delete/{{ $kab->id }}" class="btn btn-danger">
