...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('data_posyandu', function (Blueprint $table) {
            ...
            $table->string('fl_o', 1);
            $table->string('fl_naik', 1);
            $table->string('fl_turun', 1);
            $table->string('fl_tetap', 1);
            $table->string('fl_hijau', 1);
            $table->string('fl_kuning', 1);
            $table->string('fl_bgm', 1);
            $table->string('fl_pus', 1);
            $table->string('fl_wus', 1);
            $table->string('fl_ibu_hamil', 1);
            $table->string('fl_lansia', 1);
            $table->string('fl_lainnya', 1);
            $table->string('lainnya', 150);
